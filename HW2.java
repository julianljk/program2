...
public class HW2 {
	...
	public static void main(String args[]) {
		...
		while (true)
		{
			if (mode == 1 || mode == 3) {
				// Player 1's move
				int lastMove = board.getLastMove(); //-1
				int[] takenList = board.getTakenListCopy(); // returns array list
			...
			if (mode == 2) {
				// Player 1's move
				int lastMove = board.getLastMove(); //-1 initially 
				int[] takenList = board.getTakenListCopy(); //array of size n, filled with all 0's
